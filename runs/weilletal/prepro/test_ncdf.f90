...
!     sample data. To handle this in netCDF we create two
!     shared
!     dimensions, "x" and "y", and a netCDF variable,
!     called "data".
                               
!     This example demonstrates the netCDF
!     Fortran 90 API. This is part
!     of the netCDF tutorial, which can be
!     found at:
!     http://www.unidata.ucar.edu/software/netcdf/docs/netcdf-tutorial
                                              
!     Full documentation of the
!     netCDF Fortran 90 API can be
!     found at:
...
! When we create netCDF files, variables and dimensions,
...
! In this example program, wrapping netCDF calls with "call check()"
! makes sure that any return which is not equal to nf90_noerr (0) will 
! print a netCDF error message and exit. Create the netCDF file.
! The nf90_clobber parameter tells netCDF to overwrite this file, if
! it already exists.
...
! Write the pretend data to the file. Although netCDF supports reading and writing subsets of data,
! in this case we write all the data in one operation.
