...
db_main%F(11)%FieldName='upl'
db_main%F(11)%FieldType='F'
db_main%F(11)%FieldLength=12
db_main%F(11)%decimal=6

db_main%F(12)%FieldName='dpl'
db_main%F(12)%FieldType='F'
db_main%F(12)%FieldLength=12
db_main%F(12)%decimal=6

db_main%F(13)%FieldName='A_inflow'
db_main%F(13)%FieldType='F'
db_main%F(13)%FieldLength=20
db_main%F(13)%decimal=2

db_main%F(14)%FieldName='AS^k'
db_main%F(14)%FieldType='F'
db_main%F(14)%FieldLength=20
db_main%F(14)%decimal=4

db_main%F(15)%FieldName='DN'
db_main%F(15)%FieldType='F'
db_main%F(15)%FieldLength=20
db_main%F(15)%decimal=10
...
do i=1,N
   do j=1,M
      ...
      if (w_1 /= 0.0D0) then
         ...
         call Set_Field_real(db_main, db_main%F(11)%FieldName, dtm_upl(i_basin))
         call Set_Field_real(db_main, db_main%F(12)%FieldName, dtm_dpl(i_basin))
         call Set_Field_reald(db_main, db_main%F(13)%FieldName, dtm_A_inflow(i_basin))
         call Set_Field_real(db_main, db_main%F(14)%FieldName, dtm_ASk(i_basin))
         call Set_Field_real(db_main, db_main%F(15)%FieldName, dtm_DN(i_basin))
...
do i=1,N
   do j=1,M
	  ...
	  polig_tmp%Points(2)%x=xllcorner+(i-1)*delta_x
      polig_tmp%Points(2)%y=yllcorner+(j)*delta_y
	  polig_tmp%Points(3)%x=xllcorner+(i)*delta_x
	  polig_tmp%Points(3)%y=yllcorner+(j)*delta_y
	  polig_tmp%Points(4)%x=xllcorner+(i)*delta_x
      polig_tmp%Points(4)%y=yllcorner+(j-1)*delta_y
      polig_tmp%Points(5)%x=polig_tmp%Points(1)%x
      polig_tmp%Points(5)%y=polig_tmp%Points(1)%y
