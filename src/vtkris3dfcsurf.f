         subroutine vtkris3dfcsurf(ntetra, nnode,iunit,tetra,time,
     1                       u,x,y,z)
         implicit none
...
c         write(iunit,84)  ntetra
c 84      format('CELL_DATA', 1x,i8, 
c     1    /, 'VECTORS velocity float')
c         do i=1,ntetra
c             write(iunit,*) vx(i), vy(i), vz(i)
c         end do
C         write(iunit,85C) 
