...
C     
      ...
      REAL*8 MASS0,MASST,MASSINADV,MASSOUTADV,MASSINDISP,MASSOUTDISP
      REAL*8 MASSINTOTADV,MASSOUTTOTADV,MASSINTOTDISP,MASSOUTTOTDISP
...
C     
C     SET CAUCHY BC FOR TRANSPORT
C     
         IF (CDIFFUS .EQ. 0) THEN 
C ADVECTION ONLY - COUPLING BASED ON DIRICHLET
C     UPDATING THE SURFACE CONCENTRATION FOR COUPLING - LAURA PHD
C
...
C
     ...
     1        MASST,DSMASS,MASSINADV,MASSINDISP,MASSOUTADV,
     2        MASSOUTDISP,MASSINTOTADV+MASSINTOTDISP,
     3        MASSOUTTOTADV+MASSOUTTOTDISP,MERRAS,CMERRAS,MASSSURF
C
c
C----------------------------------------------------------------------
